...
with(mydata, plot(Moment, Global_active_power, type="n", xlab = "",ylab = "Global Active Power") )
...
legend("topright",legend = c("Sub_metering_1             ","Sub_metering_2","Sub_metering_3"),
        col = c("black","red","blue"), lty=1, y.intersp=1.4, bty="n")


Sys.setlocale("LC_TIME", "en_US.UTF-8")
with(mydata, plot(Moment, Voltage, type="n", ylab = "Voltage", xlab="datetime") )
with(mydata, lines(Moment, Voltage, type="l")) 

Sys.setlocale("LC_TIME", "en_US.UTF-8")
with(mydata, plot(Moment, Global_reactive_power, type="n", xlab="datetime") )
with(mydata, lines(Moment, Global_reactive_power, type="l")) 
